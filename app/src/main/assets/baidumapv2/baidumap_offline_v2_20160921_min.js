...
(function () {
    ...
    x.D.tj = function (a, b) {
        ...
        if (!d) {
            var e = c.DB[b], d = a.currentStyle || (x.ea.la ? a.style : getComputedStyle(a, p)),
    ...
    x.extend(Ka.prototype, {
        ua: function () {
            ...
            var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || p,
                b = this.ub({x: a[3], y: this.height - a[2]}, c), a = this.ub({x: this.width - a[1], y: a[0]}, c);
            return new fb(b, a)
        }, Jx: function () {
            return !!this.loaded
        }, MR: function (a, b) {
    ...
    "2" !== z.ou && (function (a, b, c) {
        (function (a, b, c) {
            ...
            var C = c.alog;
            if (!C || !C.Ho) {
                var A = b.all && a.attachEvent, B = C && C.yE || +new Date,
                    D = a.d3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), E = 0, J = {},
                    O = function (a) {
    ...
    x.extend(Dc.prototype, {
        qa: function () {
            ...
            var d = this.map, e = d.oa(), f = d.Ka, g = d.lc, i = e.Bc(f), k = this.lL(), l = k[0], m = k[1], n = k[2],
            ...
            var a = this.map, b = a.oa(), c = b.bE(a.Ka), d = a.lc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c),
                b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, k_: function (a, b, c, d) {
            var e = this;
            e.s1 = b;
            var f = this.map.oa(), g = e.XD(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]],
                k = this.wg[g];
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (i.vw) {
                    ...
                    if (this.map.Ub()) {
                        ...
                        k.style.display = "block", this.md.style.display = "none", this.map.dispatchEvent(new N("vectorchanged"), {isvector: q})
                    }
                }
                if (!i.ZH && !(i.mp && !this.map.Ub() || i.iM && this.map.Ub())) {
                    ...
                    var u = e.Bc(m), k = e.bE(m), l = Math.ceil(f.lng / k), v = Math.ceil(f.lat / k), w = e.k.Ob,
                    ...
                    var C = this.wg, w = -this.RJ.lng / u, y = this.RJ.lat / u, u = [Math.ceil(w), Math.ceil(y)],
                        f = d.fa(), A;
                    for (A in C) {
                        var B = C[A], D = B.info;
    ...
    var Sc = [z.url.proto + z.url.domain.TILE_BASE_URLS[0] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[1] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[2] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[3] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[4] + "/it/"],
        ...
        Uc = {dark: "dl", light: "ll", normal: "pl"}, Vc = new Ec;
    Vc.f_ = o;
            ...
            if (!b || !c || !c.lngLat || !c.panoInstance) {
                ...
                this.fo.dC(b, function (b) {
                    b ? e.fo.qj(c.lngLat, Yd.mP, function (b) {
                        if (b && b.id) {
                            var f = b.id, k = b.vh, b = b.wh, l = bc.Sd.nh(c.lngLat), m = e.aS(l, {x: k, y: b}),
    ...
    a:{
        for (var ce = ["t", "webkitT", "MozT", "msT", "OT"], de, ee = 0, fe = ce.length;
             ee < fe; ee++) {
    ...
    Fe.prototype = {
        ...
        $u: function (a) {
            if (!(te && 0 !== a.touches.length)) {
                var b = this, c = te ? a.changedTouches[0] : a, d, e, f = {Aa: 0, time: 0}, g = {Aa: 0, time: 0},
