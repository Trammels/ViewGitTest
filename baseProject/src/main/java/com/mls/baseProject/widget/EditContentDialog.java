...
public class EditContentDialog extends Dialog {
    ...
    public EditContentDialog getDialog(String title, String hintContent, String content) {
    ...
    public EditContentDialog getDialog(String title) {
        b = new Builder(mContext);
        b.setMessage(title, "", "");
        dialog = b.create();
        dialog.show();
    ...
    public static class Builder {
        ...
        public EditContentDialog create() {
            ...
            final EditContentDialog dialog = new EditContentDialog(context,
                    R.style.Dialog);
            dialog.setCanceledOnTouchOutside(false);
            View layout = inflater.inflate(R.layout.view_edit_content_dialog, null);
...
//            });
    ...
    public interface EditDialogListener {
        void sure(String editContent, EditContentDialog dialog);

        void cancel(EditContentDialog dialog);
    }
