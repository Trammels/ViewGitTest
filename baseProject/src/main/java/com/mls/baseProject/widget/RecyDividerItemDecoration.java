...
/**
 * Created by chenxiuxiang on 2017/3/26.
 */

public class RecyDividerItemDecoration extends RecyclerView.ItemDecoration {
    private int space;
    private int color = -1;
    ...
    public RecyDividerItemDecoration(int space) {
        this.space = space;
    }

    public RecyDividerItemDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecyDividerItemDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecyDividerItemDecoration(int space, Drawable mDivider) {
        this.space = space;
